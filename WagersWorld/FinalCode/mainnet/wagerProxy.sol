...
contract Wager is Initializable, IPermit, EIP712Upgradeable,OwnableUpgradeable, NoncesUpgradeable,UUPSUpgradeable   {
    ...
    function nonces(address owner) public view virtual override(IPermit, NoncesUpgradeable) returns (uint256) {
